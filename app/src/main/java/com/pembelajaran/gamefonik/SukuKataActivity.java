...
public class SukuKataActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonya  = (Button)findViewById(R.id.yaBtn);
        buttonya.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Log.i("info", ""+v.getTag());
                ...
                if(v.getTag() != null)
                    intent.putExtra("id", "" + v.getTag().toString());
                intent.putExtra("view",""+ buttonya);
                startActivity(intent);
            }
        });
        buttonyi  = (Button)findViewById(R.id.yiBtn);
        buttonyi.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Log.i("info", ""+v.getTag());
                ...
                if(v.getTag() != null)
                    intent.putExtra("id", "" + v.getTag().toString());
                intent.putExtra("view",""+ buttonyi);
                startActivity(intent);
            }
        });
        buttonyu  = (Button)findViewById(R.id.yuBtn);
        buttonfu.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                ...
                if(v.getTag() != null)
                    intent.putExtra("id", "" + v.getTag().toString());
                intent.putExtra("view",""+ buttonyu);
                startActivity(intent);
            }
        });
        buttonye  = (Button)findViewById(R.id.yeBtn);
        buttonye.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Log.i("info", ""+v.getTag());
                ...
                if(v.getTag() != null)
                    intent.putExtra("id", "" + v.getTag().toString());
                intent.putExtra("view",""+ buttonye);
                startActivity(intent);
            }
        });
        buttonyo  = (Button)findViewById(R.id.yoBtn);
        buttonyo.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v)
            {
                Log.i("info", ""+v.getTag());
